                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive" id="institue">
                        <form action="" class="es-form es-add-form">
                            <a href="{{ route('add.about_content') }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
                            <!---- slide show table  ----->
                            <table id="oiopp" class="table table-bordered mt-3 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr id="tr_{{$value->id}}">
                                        ...
                                        <td>{{$value->status}}</td>
                                        <td>
                                            <a href="{{route('content.about.edit', $value->id)}}"><i class="fa-solid fa-pencil"></i></a>&nbsp &nbsp
    ...
    $('.deleteRecord').click(function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('content.about.delete') }}",
                    data: {
                        'del_id': del_id
                    },
