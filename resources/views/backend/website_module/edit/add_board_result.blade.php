                    ...
                    <form action="{{route('update.bresult')}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <input type="number" value="{{$findId->t_student}}" name="t_student" id="total"><br>
                                @error('t_student')
                                <strong class="text-danger">{{$message}}</strong>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <input type="number" value="{{$findId->pass_student}}" name="pass_student" id="pass"><br>
                                @error('pass_student')
                                <strong class="text-danger">{{$message}}</strong>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <input type="text" name="t_plass" value="{{$findId->t_plass}}" id=""><br>
                                @error('t_plass')
                                <strong class="text-danger">{{$message}}</strong>
                                @enderror
                            </div>
