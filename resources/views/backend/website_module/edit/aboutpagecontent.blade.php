        ...
        <section class="es-form-area">
            <div class="card">
                <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                    <h2 class="text-white mb-0">Update About Page Content</h2>
                </header>
                <div class="session_add">
                    <form action="{{route('Update.about.content')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <input type="hidden" value="{{$find_id->id}}" name="edit_id">
                                @error('manu')
                                <strong class="text-danger">{{$message}}</strong>
                                @enderror
                            </div>
