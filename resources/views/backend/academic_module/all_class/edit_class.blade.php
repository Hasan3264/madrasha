        ...
        <section class="es-form-area">
            <div class="card">
                ...
                <div class="session_view_link mt-5 ml-4 mb-2">
                    ...
                    <a href="{{ route('class-view',$class_data->id) }}" class="btn btn-primary"><i
                    ...
                    <form method="post" action="{{ route('update-class') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <select name="medium_name" id="">
                                    ...
                                    <option value="{{ $item->medium_code }}"
                                        {{ $item->medium_code == $class_data->medium_name ? 'selected' : '' }}>
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <input type="text" placeholder=" " name="class_code" id=""
                                    value="{{ $class_data->class_code }}"><br>
                                <span style="color: red;padding-left: 102px;" class="mt-2 d-block">Class code must be 2
                                    digit. For examples : Class Nine - 09</span>
                            </div>
