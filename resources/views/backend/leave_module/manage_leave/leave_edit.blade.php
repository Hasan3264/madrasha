        ...
        <section class="es-form-area">
            <div class="card">
                <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                    <h2 class="text-white mb-0">Leave Update</h2>
                </header>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <select name="emp_type" id="emp_type">
                                    ...
                                    <option value="{{$type->id}}" {{($type->id == $leaves->emp_type ?'selected':'')}}>{{$type->name}}</option>
                                    @endforeach
                                </select>
                                @error('emp_type')
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <select name="leave_type" id="">
                                    ...
                                    <option value="{{$leave->id}}" {{($leave->id == $leaves->leave_type ?'selected':'')}}>{{$leave->title}}</option>
                                    @endforeach
                                </select>
                                @error('leave_type')
                                <strong class="text-danger">{{$message}}</strong>
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <input type="date" value="{{$leaves->e_date}}" name="e_date" id="">
                                <input type="hidden" value="{{$leaves->id}}" name="leave_id" id="">
                                @error('e_date')
                                <strong class="text-danger">{{$message}}</strong>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <input type="number" value="{{$leaves->t_days}}" name="t_days" id="">
                                @error('t_days')
                                <strong class="text-danger">{{$message}}</strong>
                                @enderror
                            </div>
