        ...
        <section class="es-form-area">
            <div class="card">
                ...
                <div class="session_add">
                    <form action="{{route('update_account_head')}}" method="POST">
                        @csrf
                        <div class="row">

                            <div class="col-md-10 mb-3">
                                <label for="">A/C Type <span>*</span></label>
                                <input type="text" name="actype" value="{{$findId->actype}}" placeholder="add type">
                                <input type="hidden" name="edit_id" value="{{$findId->id}}" placeholder="add type">
