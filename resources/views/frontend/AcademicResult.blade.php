...
<div class="container">
      <div class="row m-auto">
          <div class="col-lg-10 dffdd m-auto">
            <h2 style="line-height: 50px; text-align:center; font-family:'Times New Roman', Times, serif; background-color:#6c0b0b;">Academic Result</h2>
            <table class="tabfgle">
                <thead>
                    <tr>
                        <th>Year</th>
                ...
                <tbody>
                   @foreach (App\Models\Boardresult::where('exam_type', 'A')->get() as $result)
                   <tr>
                    <td>{{$result->year}}</td>
